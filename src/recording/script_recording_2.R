## Comparison of reaction time between control and schizophrenia groups.
## Inputs: subject event files from `data/raw/events-recording`.
## Output: exploratory plots and group comparison statistics.
...
save(list = c("t_control", "t_schz"), file = project_path("data", "processed", "workspaces", "times.RData"))
